...
<head>
    ...
    {{-- Judul halaman akan diisi secara dinamis, dengan fallback "Alpha Linear" --}}
    <title>@yield('title', 'Alpha Linear')</title>

    {{-- Link Bootstrap (sebagai dasar untuk semua halaman) --}}
